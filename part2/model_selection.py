...
plt.savefig(f"graphs-2/GridCV_matrix_results_tanh_{part}_{scale_samples}_{deneme}.png")
...
plt.savefig(f"graphs-2/GridCV_matrix_results_relu_{part}_{scale_samples}_{deneme}.png")
